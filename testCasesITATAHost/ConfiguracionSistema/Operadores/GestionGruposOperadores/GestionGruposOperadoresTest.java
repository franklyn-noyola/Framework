...
public class GestionGruposOperadoresTest {
	...
	final static String[] botones_gestion_gruposoperadores= {"Informe","Enviar a vías","Volver"};
	final static String[] botonescrud_gruposoperadores= {"Crear","Modificar","Eliminar"};
	final static String[] columnasgrid_gruposoperadores= {"Grupo Op.","Descripción","Acceso a Plaza","Acceso a Vía"};
