...
public class GestionOperadoresProcess extends FormProcess {
	...
	private final TipoBy[] i_botones= {TipoBy.ID,TipoBy.ID,TipoBy.ID,TipoBy.ID};
	private final String[] str_botones= {"ctl00_ButtonsZone_BtnReport_IB_Label","ctl00_ButtonsZone_BtnSearch_IB_Label","ctl00_ButtonsZone_BtnDownload_IB_Label",
	...
	public void crear() {
		((FormRadioScreen) screen).clickBotonCrud(BotonesCrudGestionOperadores.Crear.ordinal());
	}
	
	public void vermodificar() {
		((FormRadioScreen) screen).clickBotonCrud(BotonesCrudGestionOperadores.Modificar.ordinal());
	}
	
	public void eliminar() {
		((FormRadioScreen) screen).clickBotonCrud(BotonesCrudGestionOperadores.Eliminar.ordinal());
	}
