...
import procesosITATAHost.GestionCobrador.HistoricoExpediciones.OpcionesVerLiquidacionDesplegable;
...
import testCasesITATAHost.GestionCobrador.HistoricoExpediciones.VerLiquidacionTest;
...
public class VerLiquidacionScreen extends Screen {
	...
	private final TipoBy[] i_label= {TipoBy.ID,TipoBy.ID,TipoBy.ID,TipoBy.ID};
	private final String[] str_label={"ctl00_ContentZone_txt_Seal_lbl_Description","ctl00_ContentZone_companyPlazaLane_cmb_tollCompany_lbl_Description",
	...
	private final String[] str_field={"ctl00_ContentZone_txt_Seal_box_data",null,null,"ctl00_ContentZone_dt_CashOutTime_box_date","ctl00_ContentZone_dt_CashOutTime_box_hour"};
