package ventanasITATAHost.GestionCobrador.HistoricoLiquidaciones;
...
public class HistoricoLiquidacionesScreen extends FormRadioScreen {
	...
	public HistoricoLiquidacionesScreen(TipoBy i_titulo, String str_titulo, TipoBy i_subtitulo,
	...
	public void clicarCheckDesdeHasta(OpcionesHistoricoLiquidacionesRangoFechaHora opcion) {
		crud.clickCriterioCheck(opcion.ordinal());
	}
	
	public boolean estaCheckActivado(OpcionesHistoricoLiquidacionesRangoFechaHora opcion) {
		return crud.estaChequeadoCriterioRangoFechaHora(opcion.ordinal());
	}
	
	public String leerRangoFechaHoraFecha(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public String leerRangoFechaHoraHora(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public void escribirRangoFechaHoraFecha(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo, String fecha) {
		switch (tipo) {
	...
	public void escribirRangoFechaHoraHora(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo, String hora) {
		switch (tipo) {
	...
	public void borrarRangoFechaHoraFecha(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public void borrarRangoFechaHoraHora(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public boolean hayErrorValidacionFecha(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public boolean hayErrorValidacionFechaRequerido(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public boolean hayErrorValidacionFechaFormato(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public boolean hayErrorValidacionHora(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public boolean hayErrorValidacionHoraRequerido(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
	...
	public boolean hayErrorValidacionHoraFormato(OpcionesHistoricoLiquidacionesRangoFechaHora opcion, OpcionesHistoricoLiquidacionesFechaHora tipo) {
		switch (tipo) {
