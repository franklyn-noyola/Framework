...
public class ConcesionariasScreen extends FormRadioScreen {

	public ConcesionariasScreen(TipoBy i_titulo, String str_titulo, TipoBy i_subtitulo,
		...
		super(i_titulo, str_titulo, i_subtitulo, str_subtitulo, i_botones, str_botones,  i_msgerror,
				 ...
				 i_leyendamostrado,  str_leyendamostrado,  i_botones_grid,str_botones_grid,  num_columnas);
