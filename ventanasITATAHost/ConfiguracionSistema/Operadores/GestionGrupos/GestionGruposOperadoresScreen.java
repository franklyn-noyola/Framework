...
public class GestionGruposOperadoresScreen extends FormRadioScreen {

	public GestionGruposOperadoresScreen(TipoBy i_titulo, String str_titulo, TipoBy i_subtitulo,
